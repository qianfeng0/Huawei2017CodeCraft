...
void deploy_server(char * topo[MAX_EDGE_NUM], int line_num,char * filename)
{
	...
	netSoltion.LoadNet(topo, line_num );

	//netSoltion.CalculateWorstResult();
	...
	/*
	NetLib::Dijkstra dijkstra( &netMap.GetCostMap(), 11);
	dijkstra.FindAllVertex();

	NetLib::Route route;

	dijkstra.FindClosestServer( netMap.GetRemainCapacityMap(), netMap.GetNodeArray(), route);
	*/
